...
const PartnerGender = ({navigation}) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.gendertxt}>Partner Gender</Text>
      <Text style={styles.choosetxt}>
        Select partner gender you are looking for. You can change this later
      </Text>
      ...
      <SimpleButton
        onPress={() => navigation.navigate('AddHere')}
        title="Continue"
